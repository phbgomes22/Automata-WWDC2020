/*:
 ...
 "**Finite State Machines**", what a daunting name! But don't be misled by it. FSM are very fun to toy with, and are commonly used to model all sorts of behaviors.
